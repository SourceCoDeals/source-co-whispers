...
/**
 * AppLayout is intentionally authentication-agnostic.
 * The app is configured to be fully public (no login required), so we do not
 * read session state or render auth CTAs here.
 */
      ...
      >
        <nav className="flex flex-col h-full p-4">
          ...
          <div className="mt-auto pt-4 border-t border-sidebar-border">
            <p className="text-xs text-sidebar-foreground/50 px-3">SourceCo Deal Platform</p>
          </div>
        </nav>
      </aside>
